module {
  ...
  ^bb5:  // pred: ^bb4
    ...
    %91 = llvm.fsub %89, %74 : f32
    llvm.cond_br %90, ^bb6, ^bb7
  ^bb6:  // pred: ^bb5
    %92 = llvm.fmul %91, %6 : f32
    %93 = llvm.fadd %74, %92 : f32
    llvm.br ^bb8(%93 : f32)
  ^bb7:  // pred: ^bb5
    llvm.br ^bb8(%89 : f32)
  ^bb8(%94: f32):  // 2 preds: ^bb6, ^bb7
    llvm.br ^bb9(%94 : f32)
  ^bb9(%95: f32):  // 2 preds: ^bb4, ^bb8
    llvm.br ^bb10
  ^bb10:  // pred: ^bb9
    llvm.br ^bb11
  ^bb11:  // pred: ^bb10
    %96 = llvm.add %73, %7 : i64
    llvm.br ^bb3(%96, %95 : i64, f32)
  ^bb12:  // pred: ^bb3
    %97 = llvm.add %58, %7 : i64
    llvm.br ^bb1(%97, %74 : i64, f32)
  ^bb13:  // pred: ^bb1
    %98 = llvm.extractvalue %41[1] : !llvm.struct<(ptr, ptr, i64)> 
    llvm.store %59, %98 : f32, !llvm.ptr
