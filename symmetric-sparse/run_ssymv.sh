...
# Complete MLIR pipeline for SSYMV with sparse tensor support
# This script compiles and runs ssymv.mlir with all necessary passes
...
${MLIR_RUNNER} ssymv_lowered.mlir \
  -e main \
